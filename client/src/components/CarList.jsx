                        ...
                        <div key={car._id} className="card group p-0 overflow-hidden border-0 shadow-sm hover:shadow-xl transition-all duration-300">
                            <div className="flex flex-col md:flex-row h-full">
                                ...
                                >
                                    ...
                                    {/* View Gallery Badge */}
                                    <div className="absolute bottom-4 right-4 opacity-0 translate-y-2 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300 ease-out z-10">
                                        <span className="bg-white/95 text-gray-900 px-4 py-2 rounded-xl text-xs font-bold backdrop-blur-md shadow-lg flex items-center gap-2 border border-white/20">
