...
router.put('/:id', auth, upload.array('images', 10), async (req, res) => {
    try {
        ...
        // If 'existingImages' is passed (as string array), keep them
        // This logic depends on frontend implementation. 
        // For simplicity: append new images to existing ones unless specifically logic handles replacement.
